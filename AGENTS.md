...
- The literature/Obsidian project is the sibling `../IntratumoralBac` directory. Do not edit literature cards, search strategy, or metric snapshots for a website-only request.
